  ...
  async GET(ctx) {
    ...
    try {
      ...
      const [
        ...
        backendGet("/api/v1/product-units", auth).catch(() => []) as Promise<
          ProductUnit[]
        >,
        demoModePromise,
      ]);
      return renderPage(ctx, SettingsPage, {
        authed: true,
        settings,
        templates,
        taxDefinitions,
      ...
      return renderPage(ctx, SettingsPage, { authed: true, error: String(e), demoMode });
    }
  },
  async POST(ctx) {
    const req = ctx.req;
    ...
    if (deleteId) {
      try {
        ...
        return new Response(null, {
          status: 303,
          headers: {
            Location: `/settings?section=${encodeURIComponent(sectionParam)}`,
          },
        });
      } catch (e) {
        ...
        return new Response(null, {
          ...
          headers: {
            Location: `/settings?section=${
              encodeURIComponent(sectionParam || "templates")
            }`,
          },
        });
      } catch (e) {
      ...
      <div class="md:hidden mb-4">
        <SettingsNav
          ...
          sections={[
            ...
            {
              value: link("localization"),
              label: t("Localization"),
              icon: LuLanguages,
            },
            {
              value: link("templates"),
              label: t("Templates"),
      ...
      <div class="grid grid-cols-1 md:grid-cols-[16rem_1fr] gap-4">
        ...
        <aside class="hidden md:block">
          <ul class="menu bg-base-200 rounded-box w-full">
            ...
            <li>
              <a
                href={link("localization")}
                class={section === "localization" ? "active" : undefined}
              >
            ...
            <li>
              <a
                href={link("products")}
                class={section === "products" ? "active" : undefined}
              >
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <label class="form-control">
                  ...
                  <input
                    ...
                    value={(s.companyPostalCode as string) || ""}
                    class="input input-bordered w-full"
                    data-writable
                  />
                </label>
          ...
          {section === "branding" && (
            <form method="post" class="space-y-4" data-writable>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <label class="form-control">
                  <div class="label">
                    <span class="label-text">{t("Default Template")}</span>
                  </div>
                  <select
                    name="templateId"
              ...
              <div class="grid grid-cols-1 gap-3 mt-2">
                ...
                <label class="form-control">
                  <div class="label">
                    <span class="label-text">{t("Upload Logo Image")}</span>
                  </div>
                  <input
                    id="logo-file"
                    type="file"
                ...
                <div class="flex items-center gap-3">
                  <span id="logo-error" class="text-error text-sm hidden">
                    {t("Invalid logo URL or data URI")}
                  </span>
                  <div id="logo-preview" class="hidden">
                    <img
                      id="logo-preview-img"
                      class="max-h-16 max-w-32 object-contain border rounded"
                ...
                <div id="color-suggestions" class="hidden">
                  <div class="label">
                    <span class="label-text">
                      {t("Suggested accent colors from logo:")}
                    </span>
                  </div>
              ...
              <div class="bg-base-200 rounded-box p-4">
                ...
                <div class="flex items-center gap-3">
                  ...
                  <span class="text-sm opacity-70">
                    {t("Switch between Light and Dark (DaisyUI)")}
                  </span>
                </div>
              </div>
            </div>
          ...
          {section === "localization" && (
            <form method="post" class="space-y-4" data-writable>
              <h2 class="text-xl font-semibold">
                {t("Localization settings heading")}
              </h2>

              <div class="bg-base-200 rounded-box p-4">
                <h3 class="font-semibold mb-2">
                  {t("Interface language heading")}
                </h3>
                <label class="form-control">
                  <div class="label">
                    <span class="label-text">
                      {t("Interface language label")}
                    </span>
                  </div>
                  <select
                    name="locale"
              ...
              <div class="bg-base-200 rounded-box p-4">
                ...
                <label class="form-control">
                  <div class="label">
                    <span class="label-text">{t("Display dates as")}</span>
                  </div>
                  <select
                    name="dateFormat"
                    class="select select-bordered w-full"
                  ...
                  <div class="label">
                    <span class="label-text-alt">
                      {t("Choose how dates are displayed in invoices")}
                    </span>
                  </div>
                </label>
              </div>
              ...
              <div class="bg-base-200 rounded-box p-4">
                ...
                <label class="form-control">
                  <div class="label">
                    <span class="label-text">{t("Thousands separator")}</span>
                  </div>
                  <select
                    name="numberFormat"
                    class="select select-bordered w-full"
                  ...
                  <div class="label">
                    <span class="label-text-alt">
                      {t(
                        "Controls currency formatting everywhere, including PDFs",
                      )}
                    </span>
                  </div>
                </label>
            ...
            <form method="post" class="space-y-4" data-writable>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <label class="form-control">
                  ...
                  <input
                    name="paymentMethods"
                    value={(s.paymentMethods as string) || t("Bank Transfer")}
                    class="input input-bordered w-full"
                    data-writable
                  />
                </label>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <label class="form-control">
                  ...
                  <input
                    name="paymentTerms"
                    value={(s.paymentTerms as string) || t("Due in 30 days")}
                    class="input input-bordered w-full"
                    data-writable
                  />
                </label>
              ...
              >
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <label class="form-control">
                    ...
                    <input
                      name="taxLabel"
                      value={String((s.taxLabel as string) || t("Tax"))}
                      class="input input-bordered w-full"
                      placeholder="GST / HST / PST"
                      data-writable
                    />
                  </label>
                  <label class="form-control">
          ...
          {section === "products" && (
            <div class="space-y-4">
              ...
              <ProductOptionsManager
                categories={(props.data.productCategories ??
                  []) as ProductCategory[]}
            ...
            <form method="post" class="space-y-4" data-writable>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <label class="form-control">
                  <div class="label">
                    <span class="label-text">
                      {t("Enable advanced numbering pattern")}
                    </span>
                  </div>
                  <div class="flex items-center gap-3">
                    ...
                    />
                    <span class="text-sm opacity-70">
                      {t("Invoice numbering toggle helper")}
                    </span>
                  </div>
                </label>
              </div>
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <label class="form-control">
                  ...
                  <input
                    ...
                    class="input input-bordered w-full"
                    placeholder={t("Invoice number pattern placeholder")}
                  />
                </label>
              </div>
              <p class="text-xs mt-2 opacity-70">
                {t("Invoice numbering tokens help")}
              </p>
            ...
            <div class="space-y-4">
              ...
              <form method="post" data-writable>
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <label class="form-control">
                    <div class="label">
                      <span class="label-text">{t("Default XML Profile")}</span>
                    </div>
                    <select
                      name="xmlProfileId"
                      class="select select-bordered w-full"
                  ...
                  <label class="form-control">
                    ...
                    <div class="flex items-center gap-3 mt-1">
                      ...
                      <span class="text-xs opacity-70">
                        {t("Adds selected XML as a PDF attachment")}
                      </span>
                    </div>
                  </label>
                  <label class="form-control">
                    ...
                    <div class="flex items-center gap-3 mt-1">
                      ...
                      />
                      <span class="text-xs opacity-70">
                        {t("Adds selected XML as an HTML attachment")}
                      </span>
                    </div>
                  </label>
                </div>
